...
<head>
	...
	<title>Project Coalesce</title>
</head>

<body class="index-page">
<!-- Navbar -->
	<?php require("core/modules/nav.php"); ?>
<!-- End Navbar -->
...
<div class="wrapper">
			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					<div class="brand">
						...
						<h1>Project Coalesce</h1>
						<h4>Together, we create.</h4>
					</div>
				</div>
			</div>
	...
	<?php require("core/modules/footer.php"); ?>
</div>
...
<!--  End Modal -->
	...
	<?php require("core/modules/foot.php"); ?>
</html>
